...
``` r  
> pool()
Task fetched by thread 140173991360256
Task fetched by thread 140173999752960
Task fetched by thread 140173982967552

Error in RcppThreads:::pool() : C++ call interrupted by user
```
